    ...
    <div className="space-y-16 px-6 md:px-12 relative z-10">
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-zinc-400 font-medium leading-relaxed">VIGIL models primary threat actors and their infrastructure:</p>
               ...
               <div className="p-6 bg-zinc-950 border border-zinc-900 rounded-2xl flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs leading-relaxed">
                       Botnets and high-density GPU clusters. Campaigns often utilize a **Seeder Wallet Hierarchy** (approx. 8 seeders per 80k mimics) to manage automated Look-alike Generation.
                    </p>
                  </div>
               </div>
               <div className="p-6 bg-zinc-950 border border-zinc-900 rounded-2xl flex items-start gap-4">
                  <Zap className="w-6 h-6 text-blue-900/40 mt-1" />
                  <div>
                    <h5 className="text-white font-black uppercase tracking-widest text-xs">Plug-and-Play Toolkits</h5>
                    <p className="text-zinc-500 text-xs leading-relaxed">
                       Commercialized malware available on Darknet marketplaces. These "As-a-Service" products offer user-friendly interfaces, automated targeting, and customer support for low-barrier attackers.
                    </p>
                  </div>
               </div>
               <div className="p-6 bg-zinc-950 border border-zinc-900 rounded-2xl flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs leading-relaxed">Human-led attacks that manually poison specific dApp documentation or community chats to trigger "Spear-Poisoning" events.</p>
                  </div>
               </div>
            </div>
          </div>
          <div className="lg:col-span-5">
             <TechNote title="INTEL SOURCE">
                Derived from the 2025 Solana Ecosystem Threat Audit and Chainalysis Oct 2024 Forensic Briefing. Adversaries are prioritized by the ROI potential (1,147% realized avg).
             </TechNote>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-8">
        ...
        <p className="text-zinc-400 text-lg leading-relaxed font-medium">
          Attackers send a dust transfer early to ensure their address is the first "Familiar" one you see in your Recent Transactions history.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
           <div className="p-8 bg-zinc-900/30 border border-zinc-800 rounded-[2rem] flex items-center justify-between gap-12">
              <div className="space-y-2">
                <div className="text-blue-500 font-black text-[10px] uppercase tracking-widest">CAMPAIGN LIFECYCLE</div>
                <h5 className="text-white font-black italic">66-Day Window</h5>
              </div>
              <History className="w-12 h-12 text-blue-500 opacity-20" />
           </div>
           <div className="p-8 bg-zinc-900/30 border border-zinc-800 rounded-[2rem] flex items-center justify-between gap-12">
              <div className="space-y-2">
                <div className="text-blue-500 font-black text-[10px] uppercase tracking-widest">IDLE PHASE</div>
                <h5 className="text-white font-black italic">T+14 to T+21 Days</h5>
              </div>
      ...
      <section className="pt-24 space-y-12 text-center">
        ...
        <p className="text-[10px] font-black text-zinc-800 uppercase tracking-[0.6em]">Registry Reference: VG-TM-DEFINITIVE-A2</p>
      </section>
