...
import { 
  ...
  FileText, ExternalLink, BookOpen, Quote, Info, Skull, Ghost,
  Server, TrendingUp, AlertTriangle, Link as LinkIcon
} from 'lucide-react';
...
const LINKS = {
  ...
  CERTIK: "https://www.certik.com/resources/blog/vanity-address-and-address-poisoning",
  BINANCE_SEC: "https://www.binance.com/en/blog/security/1195692545296235775",
  CHAINALYSIS: "https://www.chainalysis.com/blog/address-poisoning-scams/",
  CHAINALYSIS_2026: "https://www.chainalysis.com/blog/crypto-scams-2026/",
...
export const ResearchBriefingContent: React.FC<ResearchBriefingProps> = ({ lightMode }) => (
  <div className="space-y-24 pb-60 max-w-6xl mx-auto selection:bg-blue-500/20 relative">
    {/* Propagating lightMode to DocumentWatermark */}
    <DocumentWatermark text="INTERNAL RESEARCH BRIEFING" lightMode={lightMode} />
    
    {/* Propagating lightMode to SectionHeader */}
    <SectionHeader 
    ...
    <div className="space-y-32 px-6 md:px-12 relative z-10">
      ...
      <section className="space-y-12">
        {/* Propagating lightMode to DocCard */}
        ...
        <DocCard border="zinc" lightMode={lightMode}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
             <div className="space-y-6">
                {/* Propagating lightMode to TechLabel */}
                <TechLabel text="METHODOLOGY: PROJECT_MIRROR" color="cyan" lightMode={lightMode} />
                <h4 className="textxl font-black text-white uppercase italic">Study Parameters</h4>
      ...
      {/* PAGE 1.5: INDUSTRIALIZED DECEPTION */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="TECHNICAL NOTE 12" color="red" lightMode={lightMode} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
             <div className="lg:col-span-8 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">Sybil Industrialization</h3>
                </div>
                <p className="text-zinc-400 text-lg leading-relaxed font-medium">
                   Adversaries have transitioned from manual dusting to automated "Seeder Contracts." These programs automate the funding, generation, and deployment of mimic swarms. 
                </p>
                <div className="p-8 bg-black border border-zinc-900 rounded-3xl space-y-4">
                   <p className="text-[11px] text-zinc-500 font-bold uppercase tracking-widest leading-relaxed">
                      VIGIL identifies these campaigns by tracing funding paths back to a shared 'Mother Wallet.' High cluster density ({'>'}50 wallets funded by one source) triggers immediate system-wide escalation.
                   </p>
                </div>
             </div>
      ...
      {/* PAGE 1.6: ZERO-VALUE MECHANICS */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="TECHNICAL NOTE 13" color="cyan" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        ...
        <DocCard border="zinc" lightMode={lightMode}>
          <div className="flex flex-col md:flex-row gap-12 items-center">
             <div className="shrink-0">
                <div className="w-40 h-40 bg-zinc-950 border border-zinc-900 rounded-full flex items-center justify-center">
                   <Ghost className="w-16 h-16 text-cyan-500/30 animate-pulse" />
                </div>
             </div>
             <div className="flex-1 space-y-6">
                <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">Zero-Value Mechanics</h3>
                <p className="text-zinc-400 text-lg leading-relaxed font-medium">
                   "Dust-less Poisoning" involves triggering zero-balance transfers via smart contracts. This allows scammers to inject look-alike addresses into transaction history without needing a balance or user signature.
                </p>
                <TacticalPoisonDiagram />
                <div className="flex items-center gap-4">
                   {/* Propagating lightMode to TechLabel */}
                   <TechLabel text="STEALTH: EXTREME" color="red" lightMode={lightMode} />
                   <div className="h-[1px] flex-1 bg-zinc-900" />
                   <span className="text-[9px] font-mono text-zinc-700">Ref: ZV-INJECT-01</span>
                </div>
             </div>
          </div>
        </DocCard>
      ...
      {/* PAGE 1.7: COLLISION PROBABILITY & APS */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="TECHNICAL NOTE 14" color="purple" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           <div className="lg:col-span-7 space-y-8">
              <h3 className="text-4xl font-black text-white uppercase italic tracking-tight">Collision Probability</h3>
              <div className={`p-8 ${lightMode ? 'bg-zinc-50' : 'bg-black'} border border-zinc-900 rounded-[2.5rem] space-y-6`}>
                 <div className="flex items-center justify-between">
                    <span className="text-[10px] font-black text-purple-500 uppercase tracking-[0.4em]">Mathematical Formulation</span>
                    <div className="px-3 py-1 bg-purple-600/10 border border-purple-500/20 rounded text-[9px] font-black text-purple-500">p ≈ r / 16^d</div>
                 </div>
                 <p className="text-zinc-400 text-sm leading-relaxed">
                   Probability <b>p</b> of finding a look-alike address increases linearly with the target address space <b>r</b> and decreases exponentially with the number of matching digits <b>d</b>. For <b>d=14</b>, the expected trials are significantly lower, enabling CPU-based mass campaigns.
                 </p>
           ...
           <div className="lg:col-span-5 space-y-6">
              <div className="p-8 bg-zinc-900/30 border border-zinc-800 rounded-[2.5rem] space-y-6">
                 ...
                 <div className="space-y-3">
                    {[
                      { h: "Mac M1 (optimized)", v: "81,660 APS" },
                      { h: "Ubuntu Server (optimized)", v: "460,665 APS" },
                      { h: "RTX 8000 (Profanity2)", v: "516,437,000 APS" }
                    ].map((row, i) => (
                      <div key={i} className="flex justify-between items-center py-2 border-b border-zinc-900 last:border-0">
                         <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-tight">{row.h}</span>
                         <span className="text-[10px] font-mono text-zinc-300 font-bold">{row.v}</span>
                      </div>
                    ))}
                 </div>
                 {/* Propagating lightMode to TechLabel */}
                 <TechLabel text="GPU_ADVANTAGE: 3_ORDERS" color="red" lightMode={lightMode} />
              </div>
           </div>
        </div>
      </section>
      ...
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="EXPERIMENT: 02-A" color="blue" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
             {/* Propagating lightMode to TechNote */}
             <TechNote title="HEURISTIC_ENTROPY" lightMode={lightMode}>
      ...
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="BEHAVIORAL: 04-B" color="purple" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
      ...
      <section className="space-y-12">
        {/* Propagating lightMode to DocCard */}
        <DocCard border="cyan" lightMode={lightMode}>
           <div className="flex items-center gap-4 mb-8">
      ...
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="UI_THREAT: 06-C" color="orange" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8 space-y-8">
            <h3 className="text-4xl font-black text-white italic uppercase tracking-tight leading-none">Visual Homograph <br/> Exploitation</h3>
          ...
          <div className="lg:col-span-4 space-y-8">
             {/* Propagating lightMode to TechNote */}
             <TechNote title="RENDER_HIJACKING" lightMode={lightMode}>
      ...
      <section className="space-y-12">
        {/* Propagating lightMode to DocCard */}
        <DocCard border="blue" lightMode={lightMode}>
           <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="shrink-0">
      ...
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          {/* Propagating lightMode to TechLabel */}
          <TechLabel text="PREDICTIVE: 2026_H1" color="cyan" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           <div className="lg:col-span-7 space-y-12">
              <h3 className="text-4xl font-black text-white italic uppercase tracking-tight leading-none">AI-Assisted Contextual Injection</h3>
              ...
              <DocCard border="zinc" lightMode={lightMode}>
                 <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-zinc-900 flex justify-between items-center">
                       {/* Propagating lightMode to TechLabel */}
                       <TechLabel text="URGENCY: HIGH" color="red" lightMode={lightMode} />
      ...
      {/* PAGE 8.5: SUPPLEMENTARY 2025/2026 INDUSTRIALIZATION ANALYSIS */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          <TechLabel text="SUPPLEMENTARY: 2026_RESEARCH" color="red" lightMode={lightMode} />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 space-y-8">
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">Industrialized Fraud Standard</h3>
              </div>
              <p className="text-zinc-400 text-lg leading-relaxed font-medium">
                New multi-software forensic data confirms that crypto scams have reached terminal industrialization. Attackers now leverage "Phishing-as-a-Service" (PaaS) to execute multi-chain deception at global scale.
              </p>
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="p-8 bg-zinc-900/30 border border-zinc-800 rounded-[2.5rem] space-y-6">
                <h4 className="text-[11px] font-black text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                  <LinkIcon size={14} className="text-red-500" /> INFRASTRUCTURE ARBITRAGE
                </h4>
                <div className="space-y-4">
                   <p className="text-[10px] text-zinc-500 leading-relaxed font-bold uppercase tracking-widest italic border-l-2 border-zinc-800 pl-4">
                      Entry cost for sophisticated phishing kits has plummeted to &lt; $500, enabling low-tier actors to execute campaigns with &gt; $1B cumulative reach.
                   </p>
              ...
              <a 
                href={LINKS.CHAINALYSIS_2026} 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 w-full py-4 bg-white text-black rounded-2xl text-[9px] font-black uppercase tracking-[0.3em] hover:bg-blue-600 hover:text-white transition-all group"
              >
                VERIFY DATA LOG <ExternalLink size={12} className="group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          </div>
          
          {/* Attribution Footer - Increased Contrast from zinc-600 to zinc-400 */}
          <div className="mt-12 pt-8 border-t border-zinc-900 text-center">
             <p className={`text-[10px] ${lightMode ? 'text-zinc-500' : 'text-zinc-400'} font-bold uppercase tracking-[0.2em] max-w-2xl mx-auto italic`}>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
              {[
                ...
                { 
                  ...
                  desc: "Forensic quantification of industrialized fraud and AI-enabled scam effectiveness.",
                  url: LINKS.CHAINALYSIS_2026
                }
              ].map((cite, i) => (
                <a 
                  key={i} 
           ...
           <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1 space-y-8">
                 ...
                 <div className="pt-6 flex flex-wrap gap-4">
                    {/* Propagating lightMode to TechLabel */}
                    <TechLabel text="STATUS: PEER_REVIEWED" color="blue" lightMode={lightMode} />
                    <TechLabel text="DATASET: VIG-H2-25" color="zinc" lightMode={lightMode} />
                 </div>
              </div>
