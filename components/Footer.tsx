...
const RefractiveWordmark = () => (
  <div className="relative w-full h-[120px] md:h-[280px] pointer-events-none select-none overflow-visible flex items-center justify-center mt-2 md:mt-4">
    <svg viewBox="0 0 1000 300" className="w-full h-full opacity-100 overflow-visible">
      <defs>
        ...
        <linearGradient id="washGradient" x1="0%" x2="0%" y1="0%" y2="100%">
      ...
      <g style={{ fontFamily: '"Inter", sans-serif', fontWeight: 900 }} dominantBaseline="central" className="uppercase italic">
        ...
        {/* Layer 3: Zinc Master Stroke (Increased visibility) */}
        <text 
          x="50%" 
          y="50%" 
          textAnchor="middle" 
        ...
        {/* Layer 4: Cyan Refraction (Static, Increased visibility) */}
        ...
        {/* Layer 5: Crimson Refraction (Static, Increased visibility) */}
        <g transform="translate(0,0)">
          <text 
            x="50%" 
            y="50%" 
...
export const Footer: React.FC<FooterProps> = ({ onOpenDoc, onVersionClick }) => (
  <footer id="footer" className="relative z-50 bg-[#0a0a0a] pt-12 pb-0 px-6 md:px-20 border-t border-zinc-900/10 overflow-hidden">
    <div className="max-w-7xl mx-auto relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0 lg:divide-x lg:divide-zinc-900/40 mb-12">
        ...
        <div className="lg:px-12 space-y-8">
          <div className="space-y-4">
            <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.5em] flex items-center gap-2">
              <span className="text-zinc-500">//</span> VERIFIED CHANNELS
            </h4>
          ...
          <div className="flex flex-col gap-4">
            <a 
              href="https://x.com/Vigil_Research" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center gap-4 group cursor-pointer"
            >
              <X className="w-3.5 h-3.5 text-zinc-500 group-hover:text-white transition-all" />
            ...
            <div className="flex items-center gap-4 group cursor-default">
              <Send className="w-3.5 h-3.5 text-zinc-500 group-hover:text-blue-500 transition-all" />
            ...
            <div className="flex items-center gap-4 group cursor-default">
              <MirrorMail className="w-3.5 h-3.5 text-zinc-500 group-hover:text-blue-400 transition-all" />
        ...
        <div className="lg:px-12 space-y-12">
          <div className="space-y-6">
            <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.5em] flex items-center gap-2">
              <span className="text-zinc-500">//</span> PRODUCT
            </h4>
            <ul className="space-y-5">
              <li><button onClick={() => onOpenDoc('pricing')} className="text-xs font-black text-zinc-500 hover:text-white transition-all text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <Tag className="w-4 h-4 text-zinc-500 group-hover:text-emerald-500 transition-colors" /> Plans & Access
              </button></li>
              <li><button onClick={() => onOpenDoc('how_to_use')} className="text-xs font-black text-zinc-500 hover:text-white transition-all text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <BookOpen className="w-4 h-4 text-zinc-500 group-hover:text-blue-500 transition-colors" /> Operational Manual
              </button></li>
              <li><button onClick={() => onOpenDoc('press_kit')} className="text-xs font-black text-zinc-500 hover:text-white transition-all text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <Share2 className="w-4 h-4 text-zinc-500 group-hover:text-purple-500 transition-colors" /> Media Kit
              </button></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.5em] flex items-center gap-2">
              <span className="text-zinc-500">//</span> RESOURCES
            </h4>
            <ul className="space-y-5">
              <li><button onClick={() => onOpenDoc('identity_manifest')} className="flex items-center gap-4 text-xs font-black text-zinc-500 hover:text-white transition-all text-left uppercase tracking-[0.2em] group/link">
                <Fingerprint className="w-4 h-4 text-zinc-500 group-hover:text-cyan-500 transition-colors" /> Identity Manifest
              </button></li>
              <li><button onClick={() => onOpenDoc('whitepaper')} className="flex items-center gap-4 text-xs font-black text-zinc-500 hover:text-white transition-all text-left uppercase tracking-[0.2em] group/link">
                <FileText className="w-4 h-4 text-zinc-500 group-hover:text-zinc-200 transition-colors" /> Whitepaper
              </button></li>
              <li><button onClick={() => onOpenDoc('technical_doc')} className="flex items-center gap-4 text-xs font-black text-zinc-500 hover:text-white transition-all text-left uppercase tracking-[0.2em] group/link">
                <BookOpen className="w-4 h-4 text-zinc-500 group-hover:text-blue-400 transition-colors" /> Technical Doc
              </button></li>
            </ul>
          </div>
        </div>
        ...
        <div className="lg:pl-12 space-y-10">
          <div className="space-y-6">
            <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.5em] flex items-center gap-2">
              <span className="text-zinc-500">//</span> GOVERNANCE
            </h4>
            <ul className="space-y-5">
              <li>
          ...
          <div className="p-6 bg-[#0c0c0c] border border-zinc-900/50 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h5 className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">Integrity Note</h5>
            </div>
      ...
      <div className="pt-8 pb-4 border-t border-zinc-900/10 flex flex-col md:flex-row justify-between items-center gap-8 relative z-20">
        <div className="space-y-2 text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start gap-4">
            ...
            <div className="h-3 w-[1px] bg-zinc-500" />
            <button 
              onClick={onVersionClick}
              className="text-[8px] font-black text-zinc-500 uppercase tracking-widest italic hover:text-blue-500 transition-colors cursor-pointer"
            >
 ...
 * Mail Icon Helper
 */
const MirrorMail = ({ className }: { className?: string }) => (
