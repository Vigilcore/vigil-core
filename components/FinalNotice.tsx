  ...
  return (
    <section className="px-6 md:px-20 py-8 bg-[#020202] relative z-10 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="p-[1.5px] bg-gradient-to-r from-red-600 via-[#333] to-blue-600 rounded-3xl shadow-[0_0_60px_rgba(0,0,0,0.8)]">
          <div className="bg-black rounded-3xl px-8 py-10 md:py-12 md:px-16 text-center space-y-8 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="max-w-3xl mx-auto">
                <p className="text-lg md:text-2xl text-zinc-300 font-medium leading-[1.3] italic">
                  "By using VIGIL, you acknowledge that <span className="text-white border-b border-zinc-700 pb-0.5">security is probabilistic</span>, <span className="text-white border-b border-zinc-700 pb-0.5">not absolute</span>, and that human vigilance remains essential even with advanced tooling."
                </p>
              </div>
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2.5 px-5 py-2 bg-zinc-950 border border-zinc-800 rounded-full shadow-inner group cursor-default">
