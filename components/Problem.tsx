    ...
    <section id="the-threat" className="flex flex-col items-center justify-center p-1 md:p-12 py-8 relative overflow-hidden bg-[#020202]">
      <div ref={containerRef} className="w-full max-w-6xl space-y-10 md:space-y-12 relative z-10">
        <div className={`text-center space-y-6 max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-[2.25rem] md:text-[4.5rem] font-black text-white italic uppercase tracking-tighter leading-[0.8]">Failure of Reactive Models</h2>
          <div className="space-y-4">
            ...
            <button 
              ...
              className="mt-4 md:mt-6 inline-flex items-center gap-2 text-[10px] font-black text-red-500 uppercase tracking-widest hover:text-red-400 transition-colors animate-pulse-subtle"
            >
              <FileWarning className="w-3.5 h-3.5" /> [READ_INTEL_REPORT: VG-TM-2026]
            </button>
          </div>
        </div>
