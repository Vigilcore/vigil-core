...
const DIRECTIVES: DailyDirective[] = [
  { day: 1, word: "Ab1C92kLp6mX9wR7yT5vB4nQ8jK3mZz90", subtext: "Looks right.", code: "VG-01-CLARITY" },
  { day: 2, word: "TRUST", subtext: "A VULNERABILITY WRAPPED IN A PROMISE.", code: "VG-02-GEN" },
  { day: 3, word: "CUSTODY", subtext: "THE EXIT IS A BUTTON. IT CAN BE DELETED.", code: "VG-03-GEN" },
  { day: 4, word: "INFLUENCE", subtext: "THE CROWD IS A HUMAN-LAYER BOTNET.", code: "VG-04-GEN" },
  { day: 5, word: "LOSS", subtext: "NINETEEN PARTS BELIEF. ONE PART REALITY.", code: "VG-05-GEN" },
  { day: 6, word: "PROVENANCE", subtext: "TRACE THE GENESIS OR INHERIT THE TRAP.", code: "VG-06-INTEL" },
  { day: 7, word: "ENTROPY", subtext: "THE ADVERSARY FEEDS ON CHAOS.", code: "VG-07-INTEL" },
  { day: 8, word: "SACCADE", subtext: "THE EYE SKIPS. THE THEFT LIVES IN THE GAP.", code: "VG-08-BIO" },
  { day: 9, word: "COLLISION", subtext: "WHEN TWO DESTINATIONS WEAR ONE FACE.", code: "VG-09-WAR" },
  { day: 10, word: "VOID", subtext: "DATA WITHOUT CONTEXT IS A WEAPON.", code: "VG-10-CORE" },
  { day: 11, word: "MIMICRY", subtext: "THE POISON IS A FAMILIAR REFLECTION.", code: "VG-11-WAR" },
  { day: 12, word: "LATENCY", subtext: "12ms IS THE DIFFERENCE BETWEEN SIGHT AND LOSS.", code: "VG-12-BIO" },
  { day: 13, word: "MESH", subtext: "COLLECTIVE INTELLIGENCE IS THE ONLY SHIELD.", code: "VG-13-SYNC" },
  { day: 14, word: "HEURISTIC", subtext: "PATTERN RECOGNITION IS THE ULTIMATE VALIDATOR.", code: "VG-14-CORE" },
  { day: 15, word: "BETRAYAL", subtext: "INSTITUTIONS ARE MONOLITHS OF SYSTEMIC RISK.", code: "VG-15-INTEL" },
  { day: 16, word: "SOVEREIGN", subtext: "YOUR INTENT IS THE ONLY AUTHORITY.", code: "VG-16-GOV" },
  { day: 17, word: "INTERCEPT", subtext: "NEUTRALIZE DECEPTION AT THE RETINAL PERIMETER.", code: "VG-17-WAR" },
  { day: 18, word: "VANITY", subtext: "FORCED ENTROPY IS A MATHEMATICAL LIE.", code: "VG-18-MATH" },
  { day: 19, word: "PERSISTENCE", subtext: "VIGILANCE IS NOT A TASK; IT IS A STATE.", code: "VG-19-CORE" },
  { day: 20, word: "MIMICRY", subtext: "THE POISON WEARS A FAMILIAR FACE.", code: "VG-20-WAR" },
  { day: 21, word: "AUDIT", subtext: "VERIFY THE LINEAGE OR SURRENDER THE ASSET.", code: "VG-21-INTEL" },
  { day: 22, word: "BIOMETRIC", subtext: "YOUR SENSORS ARE THE FINAL FIREWALL.", code: "VG-22-BIO" },
  { day: 23, word: "FINALITY", subtext: "BLOCKCHAIN SETTLEMENT HAS NO REVERSE GEAR.", code: "VG-23-CORE" },
  { day: 24, word: "PROTOCOL", subtext: "RULES FOR SURVIVAL IN A HOSTILE DOM.", code: "VG-24-GOV" },
  { day: 25, word: "SACCADE", subtext: "THE BLIND SPOT IS WHERE THE THEFT LIVES.", code: "VG-25-WAR" },
  { day: 26, word: "REPUTATION", subtext: "MERIT IS MEASURED IN INTERCEPTS.", code: "VG-26-SYNC" },
  { day: 27, word: "DISENGAGE", subtext: "EXIT THE FACILITY. STAY VIGILANT.", code: "VG-27-VOID" },
  { day: 28, word: "SHIELD", subtext: "A PROBABILISTIC FILTER FOR A HOSTILE WORLD.", code: "VG-28-CORE" },
  { day: 29, word: "SYNC", subtext: "NEURAL PARITY ESTABLISHED.", code: "VG-29-SYNC" },
  { day: 30, word: "VIGIL", subtext: "VIGILANCE IS THE ONLY PERMANENT SHIELD.", code: "VG-30-FINAL" },
];
...
export const NarrativeGlitchForge: React.FC = () => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.download = `VIGIL_NARRATIVE_NODE_${day}_${level}_${Date.now()}.png`;
      ...
      <div className="flex flex-col lg:flex-row justify-between items-end gap-8 border-b border-zinc-900 pb-12">
        <div className="space-y-6">
          ...
          <p className="text-zinc-500 text-lg font-medium italic max-w-xl">
            "Generate high-impact tactical glitches. Feed the community with sovereign imagery."
          </p>
        </div>
                ...
                <div className="grid grid-cols-6 gap-2">
                   {DIRECTIVES.map(d => (
                     <button 
                       ...
                       className={`aspect-square rounded-xl border text-[10px] font-black transition-all flex items-center justify-center ${day === d.day ? 'bg-blue-600 border-blue-500 text-white' : 'bg-black border-zinc-900 text-zinc-700 hover:text-zinc-300'}`}
                     >
        ...
        <div className="lg:col-span-8">
           <div className="relative group w-full border-2 border-zinc-900 rounded-[3rem] bg-[#020202] p-4 md:p-8 shadow-inner overflow-hidden flex justify-center h-[500px] md:h-[600px] items-center">
              ...
              <div 
                ...
                ref={captureRef}
                className="relative w-full max-w-[1080px] aspect-square bg-[#050505] overflow-hidden flex flex-col items-center justify-center p-20 shrink-0"
                style={{ 
           ...
           <div className="mt-6 flex items-center justify-between opacity-40">
              ...
              <div className="flex items-center gap-4">
                 ...
                 <span className="text-[10px] font-black text-zinc-700 uppercase tracking-widest">VG-CORE-FORGE // RENDER_ENGINE: v1.0.6_TACTICAL</span>
              </div>
           </div>
        </div>
      </div>
