          ...
          <div className="lg:col-span-7 space-y-8 md:space-y-12">
              ...
              <div className="flex flex-col gap-6 md:gap-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-bold text-cyan-500 uppercase tracking-[0.4em]">Active</span>
                  </div>
                </div>
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-8 md:space-y-12">
               <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6">
                 ...
                 <button onClick={() => onOpenDoc('whitepaper')} className="px-6 md:px-12 py-5 md:py-6 border-2 border-zinc-700 text-white text-[11px] md:text-[12px] font-black uppercase tracking-[0.3em] hover:bg-zinc-900 hover:border-zinc-500 transition-all rounded-lg">READ WHITEPAPER</button>
               </div>
        ...
        >
           <div className="text-center space-y-6 mb-12 md:mb-16">
              <div className="flex items-center justify-center gap-6">
                 ...
                 <span className="text-blue-500 font-black text-[10px] md:text-[11px] uppercase tracking-[0.6em] animate-pulse">Neural Link Audit Required</span>
                 <div className="h-[1px] w-12 md:w-16 bg-zinc-900" />
              </div>
              <div className="space-y-4">
