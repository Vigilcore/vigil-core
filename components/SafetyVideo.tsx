...
import { ShieldCheck, Info, Binary, Search, Lock, CheckCircle2, Fingerprint, Activity, MousePointer2, Shield, Layers, Copy, Triangle, Terminal, Zap, ChevronRight } from 'lucide-react';
import { RegistryDoc } from './OperationalRegistry';

const ValidationSnapshot = ({ onOpenDoc }: { onOpenDoc?: (doc: RegistryDoc) => void }) => (
  <div className="relative w-full p-8 md:p-12 bg-[#080808] border border-zinc-900 rounded-3xl shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] overflow-hidden group">
...
const ArchitecturalFlowCard = () => (
  <div className="w-full p-6 md:p-12 lg:p-16 bg-[#030712] border border-blue-900/30 rounded-3xl shadow-2xl relative overflow-hidden mb-0 group">
    ...
    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
      <div className="lg:col-span-5 space-y-10">
        ...
        <div className="p-8 bg-[#081126] border border-cyan-900/40 rounded-3xl flex items-start gap-5 shadow-lg group-hover:border-cyan-500/30 transition-colors">
      ...
      <div className="lg:col-span-7 flex justify-center">
        <div className="relative w-full max-w-sm flex flex-col items-center">
          ...
          <div className="relative z-20 group/box_main">
            <div className="absolute -inset-3 border border-orange-500/10 rounded-3xl pointer-events-none group-hover/box_main:border-orange-500/40 transition-colors duration-500" />
            <div className="relative w-full max-w-[22rem] py-5 px-8 bg-[#020b18] border-2 border-orange-500 rounded-3xl flex flex-col items-center gap-4 shadow-[0_0_40px_rgba(249,115,22,0.1)] transition-all duration-300 hover:scale-[1.03] cursor-pointer animate-receive-orange">
               <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(249,115,22,0.1),transparent_70%)] rounded-3xl pointer-events-none" />
               ...
               <div className="relative z-10 px-6 py-2.5 border border-orange-500/40 rounded-full bg-orange-950/20 hover:bg-orange-900/30 transition-colors group/pill cursor-default">
                  <span className="text-[12px] font-black text-white uppercase tracking-flow-[0.4em] whitespace-nowrap">Intent Validation</span>
               </div>
            </div>
          </div>
          ...
          <div className="relative z-10 group/layer1 max-w-[16rem] w-full flex flex-col items-center">
             <div className="absolute -inset-2.5 border border-emerald-900/20 rounded-3xl pointer-events-none transition-all duration-500 group-hover/layer1:border-emerald-600/30" />
...
export const SafetyVideo: React.FC<{ onOpenDoc?: (doc: RegistryDoc) => void; onUnlockNext?: () => void; isNextLocked?: boolean }> = ({ onOpenDoc, onUnlockNext, isNextLocked }) => (
  <section id="deep-dive" className="bg-[#020202] pt-4 md:pt-8 pb-0 px-6 md:px-20 relative z-20 text-white scroll-mt-20">
    <div className="max-w-7xl mx-auto">
      <div className="text-center space-y-6 mb-20 max-w-4xl mx-auto">
        ...
        <h2 className="text-[2.25rem] md:text-[4.5rem] font-black text-white italic uppercase tracking-tighter leading-[0.8]">Operational Workflow</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start mb-24">
        <div className="lg:col-span-6 space-y-16">
          ...
          <div className="p-8 bg-zinc-950 border border-zinc-900 rounded-3xl flex items-start gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-zinc-500 font-medium leading-relaxed uppercase tracking-tight">
                VIGIL is architecthetically isolated from transaction signing.
              </p>
              <button 
                 onClick={() => onOpenDoc?.('technical_spec')}
              ...
              >
                <Terminal className="w-3 h-3" /> [READ_PROTOCOL_SPEC: VG-ARCH-0.5]
              </button>
            </div>
          </div>
        </div>
